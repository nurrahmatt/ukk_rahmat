                                ...
                                <form action="proses_update_pembelian.php" method="post">
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="nomor_telepon" class="form-control" value="<?= $d['nomor_telepon']; ?>">
                                        </div>
                                        <div class="form-group">
                                            <label>Alamat</label>
            ...
            <form action="proses_pembelian.php" method="post">
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="number" required name="pelanggan_id" value="<?= date("dmHis") ?>" class="form-control" readonly>
                    </div>
                    <div class="form-group">
                        <label>Nama Pelanggan</label>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" required name="nomor_telepon" class="form-control">
                    </div>
                    <div class="form-group">
                        <label>Alamat</label>
