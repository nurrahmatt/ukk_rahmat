        ...
        while($d = mysqli_fetch_array($data)){
                                ...
                                <form method="post" action="hitung_subtotal.php">
                                    ...
                                    while($d_produk = mysqli_fetch_array($produk)){
                                        ...
                                        if ($d_produk['produk_id']==$d_detail_penjualan['produk_id']) { ?>
                                            <input type="number" name="harga" value=<?= $d_produk['harga']; ?> hidden>
                                            <input type="number" name="produk_id" value=<?= $d_produk['produk_id']; ?> hidden>
                                            <input type="number" name="stok" value=<?= $d_produk['stok']; ?> hidden>
                                            <?php
                                        }
                                    }
                                    ?>
                                    <div class="form-group">
                                        <input type="number" name="jumlah_produk" value="<?= $d_detail_penjualan['jumlah_produk']; ?>" class="from_control">
                                    </div>
                                </td>
            ...
            <form method="post" action="simpan_total_harga.php">
                ...
                <div class="row">
                    <div class="col-sm-10">
                        <div class="form-group">
                            <input type="number" class="form-control" name="total_harga" value="<?= $sum ?>">
                            <input type="number"  name="pelanggan_id" value="<?= $d['pelanggan_id'] ?>" hidden>
                            <input type="text"  name="penjualan_id" value="<?= $d['penjualan_id'] ?>" hidden>
                        </div>
                    </div>
                    <div class="col-sm-2">
